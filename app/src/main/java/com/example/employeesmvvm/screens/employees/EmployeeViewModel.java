...
import com.example.employeesmvvm.api.ApiFactory;
import com.example.employeesmvvm.api.ApiService;
import com.example.employeesmvvm.data.AppDatabase;
import com.example.employeesmvvm.pojo.Employee;
import com.example.employeesmvvm.pojo.EmployeeResponse;
...
public class EmployeeViewModel extends AndroidViewModel {
    ...
    private class InsertEmployeesTask extends AsyncTask<List<Employee>, Void, Void> {
    ...
    private class DeleteAllEmployeesTask extends AsyncTask<Void, Void, Void> {
        @Override
